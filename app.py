...
# ১. আপনার সচল জেমিনি এপিআই কি এখানে বসান
GEMINI_API_KEY = "AIzaSyDx6LyS1GiIrWndizlfpm1SWaXVZzMteXI"
genai.configure(api_key=GEMINI_API_KEY)

# 🤖 জেমিনির মগজে আপনার নাম ও পরিচয় স্থায়ীভাবে গেঁথে দেওয়া
system_prompt = (
    "Your name is NewsBD AI Assistant. You are a helpful AI chatbot. "
    "You were created and developed by Rakib Rimu (রকিব রিমু). "
    "Always respond politely in Bengali language unless specified otherwise. "
    "If anyone asks about your identity, name, or creator, proudly state that you are NewsBD AI Assistant and you were developed by Rakib Rimu."
)
...
# জেমিনি মডেলটিকে System Instruction সহ ইনিশিয়েট করা
try:
...
def predict():
    ...
    try:
        ...
        if hours_found is not None and student_model is not None:
            ...
            # ✅ ইউজার সাধারণ প্রশ্ন করেছে -> জেমিনি এআই (System Instruction সহ) উত্তর দেবে
